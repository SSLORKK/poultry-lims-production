  ...
  return (
    <div className="p-3 sm:p-4 lg:p-6 pb-20 lg:pb-6">
      <div className="mb-4 lg:mb-6">
        <h1 className="text-xl sm:text-2xl font-bold mb-3 lg:mb-4">Dashboard</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 sm:items-end">
          <div className="flex-1 sm:flex-none">
            ...
            <input
              ...
              className="w-full sm:w-auto border border-gray-300 rounded-lg px-3 py-2.5 sm:py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
            />
          </div>
          <div className="flex-1 sm:flex-none">
        ...
        <div className="space-y-4 lg:space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-3 sm:p-4 lg:p-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-3 lg:mb-4">
              <h2 className="text-base sm:text-lg lg:text-xl font-semibold">Sample Statistics</h2>
              <div className="text-xl sm:text-2xl font-bold text-blue-600">
                {samplesData?.total || 0} <span className="text-xs sm:text-sm font-normal text-gray-500">total samples</span>
              </div>
            </div>
            <p className="text-gray-600 text-xs sm:text-sm mb-3 lg:mb-4">
          ...
          {/* Tests by Department Chart */}
          <div className="bg-white rounded-xl shadow-md p-3 sm:p-4 lg:p-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-3 lg:mb-4">
              <h2 className="text-base sm:text-lg lg:text-xl font-semibold">Tests by Department</h2>
              <div className="text-xl sm:text-2xl font-bold text-green-600">
                {unitsData?.total || 0} <span className="text-xs sm:text-sm font-normal text-gray-500">total units</span>
              </div>
            </div>
            <p className="text-gray-600 text-xs sm:text-sm mb-3 lg:mb-4">
              {unitsData?.period || 'Loading...'}
            </p>
            <div className="h-56 sm:h-72 lg:h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6">
            {unitsData?.departments.map((dept) => {
              ...
              return (
                <div key={dept.department_id} className="bg-white rounded-xl shadow-md p-4 lg:p-6">
                  <div
                    className="w-full h-1.5 lg:h-2 rounded-full mb-3 lg:mb-4"
                    style={{ backgroundColor: color }}
                  />
                  <h3 className="text-base lg:text-lg font-semibold mb-2">{dept.department_name}</h3>

                  <div className="flex flex-wrap gap-3 lg:gap-4 mb-2">
                    <div className="min-w-[60px]">
                      <div className="text-2xl lg:text-3xl font-bold text-gray-700">
                        {dept.sample_count}
                      </div>
                      <p className="text-gray-500 text-xs lg:text-sm mt-0.5 lg:mt-1">samples</p>
                    </div>
                    {(dept.department_code === 'MIC' || dept.department_code === 'PCR') && (
                      <div className="min-w-[60px]">
                        ...
                        <p className="text-gray-500 text-xs lg:text-sm mt-0.5 lg:mt-1">Sub-Samples</p>
                    ...
                    {dept.department_code === 'SER' && (
                      <div className="min-w-[60px]">
                        ...
                        <p className="text-gray-500 text-xs lg:text-sm mt-0.5 lg:mt-1">Wells</p>
                      </div>
                    )}
                    <div className="min-w-[60px]">
                      <div className="text-2xl lg:text-3xl font-bold text-gray-700">
                      ...
                      <p className="text-gray-500 text-xs lg:text-sm mt-0.5 lg:mt-1">tests</p>
                    </div>
                  </div>

                  <div className="h-20 lg:h-[120px] mt-3 lg:mt-4">
                    <ResponsiveContainer width="100%" height="100%">
